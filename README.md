...
| [**TradeData**](https://tradedata.io) | Institutional customs manifest data, bill of lading analytics, and global trade intelligence across 10 sovereign nations. | **Free Trial** |
...
| API | Description | Open/Trial |
| --- | ----------- | ---- |
| [**ExtendsClass**](https://extendsclass.com/fake-api.html) | Collection of free REST APIs designed to help web developers with prototyping. | **N/A** |
